...
/// </summary>
public record class MarketplaceCreateAgentParams : ParamsBase
{
...
#pragma warning restore CS8618
    ...
    public static MarketplaceCreateAgentParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(MarketplaceCreateAgentParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/v1/marketplace/agents")
        {
