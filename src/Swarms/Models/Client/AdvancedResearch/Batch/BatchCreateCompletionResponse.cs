        ...
        IFromRaw<BatchCreateCompletionResponse>
{
    ...
    public BatchCreateCompletionResponse(IReadOnlyDictionary<string, JsonElement> properties)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    BatchCreateCompletionResponse(FrozenDictionary<string, JsonElement> properties)
    {
        this._properties = [.. properties];
    }
