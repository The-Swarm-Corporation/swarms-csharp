...
/// </summary>
public record class AutoSwarmBuilderListExecutionTypesParams : ParamsBase
{
...
#pragma warning restore CS8618
    ...
    public virtual bool Equals(AutoSwarmBuilderListExecutionTypesParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + "/v1/auto-swarm-builder/execution-types"
        )
        {
