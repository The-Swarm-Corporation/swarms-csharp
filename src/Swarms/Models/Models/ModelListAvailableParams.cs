...
/// </summary>
public record class ModelListAvailableParams : ParamsBase
{
...
#pragma warning restore CS8618
    ...
    public virtual bool Equals(ModelListAvailableParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/v1/models/available")
        {
