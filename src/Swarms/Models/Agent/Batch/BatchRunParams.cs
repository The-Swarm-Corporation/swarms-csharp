...
/// </summary>
public record class BatchRunParams : ParamsBase
{
    ...
    public required IReadOnlyList<AgentCompletion> Body
    {
        get
        {
            ...
            return this._rawBodyData.GetNotNullStruct<ImmutableArray<AgentCompletion>>("body");
        }
        init
        {
            this._rawBodyData.Set<ImmutableArray<AgentCompletion>>(
                "body",
...
#pragma warning restore CS8618
    ...
    public virtual bool Equals(BatchRunParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + "/v1/agent/batch/completions"
        )
        {
