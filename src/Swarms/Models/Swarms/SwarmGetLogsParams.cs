...
/// </summary>
public record class SwarmGetLogsParams : ParamsBase
{
    public SwarmGetLogsParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public SwarmGetLogsParams(SwarmGetLogsParams swarmGetLogsParams)
        : base(swarmGetLogsParams) { }
...
#pragma warning restore CS8618
    ...
    public virtual bool Equals(SwarmGetLogsParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/v1/swarm/logs")
        {
