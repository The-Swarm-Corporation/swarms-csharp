...
public class HttpResponse : IDisposable
{
    ...
    {
        if (obj is not global::Swarms.Core.HttpResponse other)
        {
            return false;
        }
...
public sealed class HttpResponse<T> : global::Swarms.Core.HttpResponse
{
    ...
    internal HttpResponse(
        global::Swarms.Core.HttpResponse response,
...
public sealed class StreamingHttpResponse<T> : global::Swarms.Core.HttpResponse
{
